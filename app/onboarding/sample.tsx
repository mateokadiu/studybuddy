  ...
  return (
    <View style={styles.host}>
      ...
      <Text style={styles.body}>
        a sample pdf is bundled with the app. import it now to see ingest → cards →
        review → chat without picking a file.
      </Text>
      <Pressable style={styles.cta} onPress={importSample}>
        <Text style={styles.ctaText}>import sample</Text>
      </Pressable>
      <Text style={styles.muted}>
        prefer your own pdf? skip — import any pdf from the library tab and the
        rest of the app lights up.
      </Text>
      <View style={{ flex: 1 }} />
      <Pressable
...
const styles = {
  ...
  ctaOutline: { borderColor: '#7aa2ff', borderWidth: 1, paddingVertical: 12, borderRadius: 8, alignItems: 'center' } as const,
